...
import serveasy.view.cozinheiro.NovosPedidos;
...
public class LoginScreen extends javax.swing.JFrame {
    ...
    private Usuario getValues(boolean verify) throws SQLException {
        String login, senha;
    ...
    private boolean isOpen() throws SQLException {
        return new DonoDAO().getEstadoRestaurante().equals("aberto");
    }
