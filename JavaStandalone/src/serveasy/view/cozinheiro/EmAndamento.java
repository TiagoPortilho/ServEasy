...
public class EmAndamento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblPedidosAndamento = new javax.swing.JTable();
        ...
        jScrollPane2.setViewportView(tblPedidosAndamento);
        ...
        lblPagina.setText("Pedidos em Andamento");
    ...
    private void btnEntregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntregarActionPerformed
        try {
            ...
            new PedidoDAO().setEntregue(idPedido, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmAndamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tblPedidosAndamento;
