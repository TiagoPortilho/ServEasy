...
public class NovosPedidos extends javax.swing.JFrame {
    ...
    private int IdValorSelecionado() {
        int row = tblNovosPedidos.getSelectedRow();
        if (row == -1) {
            JOptionPane.showMessageDialog(rootPane, "Selecione um pedido primeiro!", "Atenção", JOptionPane.WARNING_MESSAGE);
            return -1;
        }
        return (int) tblNovosPedidos.getValueAt(row, 0);
    }
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        int idPedido = IdValorSelecionado();
        if (idPedido == -1) {
            return;
        }
        try {
            new PedidoDAO().setConfirmado(idPedido, true);
    ...
    private void btnProntosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProntosActionPerformed
        new PedidosProntos().setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovosPedidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new NovosPedidos().setVisible(true);
        });
    }
