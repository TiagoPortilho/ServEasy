...
public class PedidosProntos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblPaginas.setText("Pedidos Prontos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PedidosProntos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
