...
public class SeusPedidos extends javax.swing.JFrame {
    ...
    public SeusPedidos(int i) throws SQLException {
        initComponents();
        this.num_mesa = i;
    ...
    public SeusPedidos(int i, int a) throws SQLException {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeusPedidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SeusPedidos().setVisible(true);
        });
    }
