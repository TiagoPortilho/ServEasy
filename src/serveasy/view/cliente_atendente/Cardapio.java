...
public class Cardapio extends javax.swing.JFrame {
    ...
    private int getIdPratoSelecionado() {
    ...
    private void btnFazerPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFazerPedidoActionPerformed
        ...
        if (row == -1) {
            ...
            if (num_mesa != 0) {
                try {
                    FazerPedido tela = new FazerPedido(num_mesa, getIdPratoSelecionado());
                    tela.setVisible(true);
                } catch (SQLException ex) {
                    new TelaErro(ex.getMessage()).setVisible(true);
                }
            } else {
                EscolherMesa tela = new EscolherMesa(1, getIdPratoSelecionado());
                tela.setVisible(true);
            }
        }
