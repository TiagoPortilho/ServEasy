...
public class Escolher_Mesa extends javax.swing.JFrame {
    ...
    public Escolher_Mesa(int opcao, int id_prato) {
        initComponents();
        this.Opcao = opcao;
    ...
    private boolean Verify(){
        ...
        if(txtMesas.getText().trim().isEmpty()){
            ...
            if(!(txtMesas.getText().matches("^[0-9]{1,3}$"))){
                ...
                Mesa mesa = new MesasDAO().buscarMesa(Integer.parseInt(txtMesas.getText()));
                if(mesa == null){
                    JOptionPane.showMessageDialog(rootPane,"Insira um número da mesa existente.");
                }
                else{
                    verify = true;
                }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if(Verify()){
            if(Opcao == 1){
                new fazer_pedido(Integer.parseInt(txtMesas.getText()), id_prato).setVisible(true);
                dispose();
            }
            else if(Opcao == 2){
                new Seus_Pedidos(Integer.parseInt(txtMesas.getText()), 10).setVisible(true);
                dispose();
            }
            else if(Opcao == 3){  
                new Pagar_Conta().fecharConta(new MesasDAO().buscarMesa(Integer.parseInt(txtMesas.getText())).getId());
                dispose();
            }
